...
function saveNote(intent, session, callback) {
    ...
    if (contentSlot) {
        ...
        speechOutput = "OK. I created a new note.";
        repromptText = "What was that?";
        shouldEndSession = true;
        var noteStoreURL = 'https://sandbox.evernote.com/shard/s1/notestore';
        //var authenticationToken = 'S=s1:U=93668:E=161c8a25d07:C=15a70f12fb8:P=1cd:A=en-devtoken:V=2:H=c242d41ccf01a2390b17cdf2cc80a232';
        //tom's
        var authenticationToken = 'S=s1:U=9371a:E=162111ebfe8:C=15ab96d9150:P=1cd:A=en-devtoken:V=2:H=00c5bfec857aa16c359b2aad6ee6f69e';
